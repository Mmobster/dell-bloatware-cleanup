...
**Machine tested:** DESKTOP-JLD47LG (Dell Inspiron)
**Date:** 2026-04-15
...
## What We Learned (From DESKTOP-JLD47LG Cleanup)

1. **SupportAssist MSI uninstaller does NOT remove DDV services.** Always check for DDV specifically.
2. **DDV services auto-start (StartType=2) from a separate `C:\Program Files\Dell\DellDataVault` folder.** They were running after the SupportAssist uninstall seemingly "succeeded."
